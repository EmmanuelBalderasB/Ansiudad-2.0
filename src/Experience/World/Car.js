...
export default class Car {
    constructor(x) {
        ...
        this.carModels = [this.resources.items.carModelWhite, this.resources.items.carModelPurple, this.resources.items.carModelBlue, this.resources.items.carModelOrange]
        // Resource
    ...
    update() {
        if (this.model.position.x <= -3) {
            this.model.position.x = this.originPointX;
        }
